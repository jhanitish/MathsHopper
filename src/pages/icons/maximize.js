...
export const Maximize = ({style, onClick}) => {
    return (
        <svg focusable="false" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" data-testid="ZoomOutMapIcon" onClick={onClick}>
